    ...
    <section id="destacados" className="relative px-6 py-28" style={{ background: "#0B0B0B" }}>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <a
            href="/catalog"
            className="group inline-flex items-center gap-3 px-8 py-4 text-sm tracking-[0.2em] uppercase font-light transition-all duration-300 hover:border-[#D4AF37] hover:text-[#D4AF37]"
            style={{
