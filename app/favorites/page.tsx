          ...
          {favPerfumes.length > 0 ? (
            ...
            >
              <div className="w-16 h-16 flex items-center justify-center mb-6"
                ...
                <Heart size={20} style={{ color: "rgba(212,175,55,0.4)" }} />
              </div>
              ...
              <Link href="/catalog"
                ...
                onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.background = "#D4AF37"; (e.currentTarget as HTMLElement).style.color = "#0B0B0B"; }}
