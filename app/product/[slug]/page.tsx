...
export default function ProductPage({
  ...
  // Build image array — one real image + placeholder angles
  const images = [
    perfume.image,
    perfume.image,
    perfume.image,
      ...
      <main className="min-h-screen bg-[#0B0B0B] text-white">
        ...
        <div className="pt-28 pb-4 px-6 border-b border-white/5">
          <div className="mx-auto max-w-7xl flex items-center gap-2 text-[11px] tracking-[0.25em] uppercase font-light"
            ...
            <Link href="/" className="hover:text-gold transition-colors" style={{ color: "rgba(255,255,255,0.3)" }}
              onMouseEnter={e => e.currentTarget.style.color = "#D4AF37"}
              onMouseLeave={e => e.currentTarget.style.color = "rgba(255,255,255,0.3)"}>
              Inicio
            </Link>
            <span>/</span>
            <Link href="/catalog" className="hover:text-gold transition-colors" style={{ color: "rgba(255,255,255,0.3)" }}
              onMouseEnter={e => e.currentTarget.style.color = "#D4AF37"}
              onMouseLeave={e => e.currentTarget.style.color = "rgba(255,255,255,0.3)"}>
              Catálogo
            </Link>
            ...
            >
              ...
              <div className="flex items-baseline gap-4 mb-8">
                ...
                {perfume.priceOriginal && (
                  <span
                    className="text-lg line-through font-light"
          ...
          <section className="py-20 px-6 relative">
            ...
            <div className="mx-auto max-w-7xl">
              <div className="mb-12 text-center">
                <p className="text-xs tracking-[0.4em] uppercase mb-3 font-light"
                ...
                {relatedPerfumes.map((rel) => (
                  <Link key={rel.slug} href={`/product/${rel.slug}`}>
                    ...
                    >
                      ...
                      <div className="p-5">
                        <p className="text-[10px] tracking-[0.3em] uppercase mb-1 font-light"
